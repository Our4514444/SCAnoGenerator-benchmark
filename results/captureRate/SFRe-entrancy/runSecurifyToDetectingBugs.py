...
#使用的常量
COMMAND = "python3 /home/pcz4514/wb/smartbugs/smartBugs.py --tool securify --file "
...
def main(_usedTool):
	...
	for contract in track(solList, description="Securify is working..."):
		try:
			#切换编译器版本
			...
			process = subprocess.run(COMMAND + contract, check = True, shell = True, stdout = detectResultLog, stderr = detectResultLog)
